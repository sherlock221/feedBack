define(function(require, exports, module) {
     ...
     * @param s 回调函数
     */
    QuackCard.prototype.draw = function(node, cover, coverType, width, height, drawPercentCallback){
    ...
    QuackCard.prototype.quick = function(node,hidden,callBack){

        var height = $(document).height();
        var width  = $(document).width();
        this.draw(node, hidden, "image", width, height, function(){
            $(node).css({"opacity":"0","visibility" : "hidden"});
            setTimeout(function(){
                callBack();
            },1000);
        });
    ...
    init: function (lottery, lotteryType) {
        ...
        if(this.vail){
            this.background = this.background || this.createElement('canvas', {
                style: 'position:fixed;top:0;width:100%;height:100%;background-color:transparent;'
            });
        }
